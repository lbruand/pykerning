#!/usr/bin/env python3
"""Typeset the 'Steam' essay using fpdf2 instead of PySide2.

This is an adapted version of examples/steam/typeset.py from python-typesetting
that uses fpdf2 for PDF generation instead of Qt.
"""
